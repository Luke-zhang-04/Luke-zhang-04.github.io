...
const Logo = (): JSX.Element => <div class="col-md-3 mt-md-0 mt-3 px-5">
    <h5 class="text-uppercase d-block text-center">Luke Zhang</h5>
    <img class="w-md-100 w-sm-50" src="images/logo-light.png"/>
</div>

const Nav = (): JSX.Element => <div class="col-md-3 mb-md-0 mb-3">
...
const Profiles = (): JSX.Element => <div class="col-md-3 mb-md-0 mb-3">
